...
fn main() {
    ...
    App::new()
        ...
        .add_systems(FixedUpdate, systems::snake_movement::move_snake)
        .add_systems(Update, (bevy::window::close_on_esc, systems::input::handle_direction_input))
        .run();
}
